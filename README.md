...
**Here is how to [speedup the build on Windows](https://github.com/rostag/bigpolicy_eu/wiki/Speed-up-the-build-on-Windows)**.

In order to start the seed use:


```bash
git clone --depth 1 https://github.com/rostag/bigpolicy_eu.git
cd angular2-seed
...
Visit the [Wiki page](https://github.com/rostag/bigpolicy_eu/wiki) of the project.
...
Please see the [CONTRIBUTING](https://github.com/rostag/bigpolicy_eu/blob/master/.github/CONTRIBUTING.md) file for guidelines.
