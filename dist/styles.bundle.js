...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js?{\"sourceMap\":false,\"importLoaders\":1}!../node_modules/postcss-loader/index.js!../node_modules/sass-loader/index.js!./bp-theme.scss", function() {
			var newContent = require("!!../node_modules/css-loader/index.js?{\"sourceMap\":false,\"importLoaders\":1}!../node_modules/postcss-loader/index.js!../node_modules/sass-loader/index.js!./bp-theme.scss");
...
// module
exports.push([module.i, "/**\n * Applies styles for users in high contrast mode. Note that this only applies\n * to Microsoft browsers. Chrome can be included by checking for the `html[hc]`\n * attribute, however Chrome handles high contrast differently.\n */\n/** The mixins below are shared between md-menu and md-select */\n/**\n * This mixin adds the correct panel transform styles based\n * on the direction that the menu panel opens.\n */\n/**\n * Applies styles for users in high contrast mode. Note that this only applies\n * to Microsoft browsers. Chrome can be included by checking for the `html[hc]`\n * attribute, however Chrome handles high contrast differently.\n */\n/**\n * This mixin contains shared option styles between the select and\n * autocomplete components.\n */\n.mat-elevation-z0 {\n  box-shadow: 0px 0px 0px 0px rgba(0, 0, 0, 0.2), 0px 0px 0px 0px rgba(0, 0, 0, 0.14), 0px 0px 0px 0px rgba(0, 0, 0, 0.12); }\n\n.mat-elevation-z1 {\n  box-shadow: 0px 2px 1px -1px rgba(0, 0, 0, 0.2), 0px 1px 1px 0px rgba(0, 0, 0, 0.14), 0px 1px 3px 0px rgba(0, 0, 0, 0.12); }\n\n.mat-elevation-z2 {\n  box-shadow: 0px 3px 1px -2px rgba(0, 0, 0, 0.2), 0px 2px 2px 0px rgba(0, 0, 0, 0.14), 0px 1px 5px 0px rgba(0, 0, 0, 0.12); }\n\n.mat-elevation-z3 {\n  box-shadow: 0px 3px 3px -2px rgba(0, 0, 0, 0.2), 0px 3px 4px 0px rgba(0, 0, 0, 0.14), 0px 1px 8px 0px rgba(0, 0, 0, 0.12); }\n\n.mat-elevation-z4 {\n  box-shadow: 0px 2px 4px -1px rgba(0, 0, 0, 0.2), 0px 4px 5px 0px rgba(0, 0, 0, 0.14), 0px 1px 10px 0px rgba(0, 0, 0, 0.12); }\n\n.mat-elevation-z5 {\n  box-shadow: 0px 3px 5px -1px rgba(0, 0, 0, 0.2), 0px 5px 8px 0px rgba(0, 0, 0, 0.14), 0px 1px 14px 0px rgba(0, 0, 0, 0.12); }\n\n.mat-elevation-z6 {\n  box-shadow: 0px 3px 5px -1px rgba(0, 0, 0, 0.2), 0px 6px 10px 0px rgba(0, 0, 0, 0.14), 0px 1px 18px 0px rgba(0, 0, 0, 0.12); }\n\n.mat-elevation-z7 {\n  box-shadow: 0px 4px 5px -2px rgba(0, 0, 0, 0.2), 0px 7px 10px 1px rgba(0, 0, 0, 0.14), 0px 2px 16px 1px rgba(0, 0, 0, 0.12); }\n\n.mat-elevation-z8 {\n  box-shadow: 0px 5px 5px -3px rgba(0, 0, 0, 0.2), 0px 8px 10px 1px rgba(0, 0, 0, 0.14), 0px 3px 14px 2px rgba(0, 0, 0, 0.12); }\n\n.mat-elevation-z9 {\n  box-shadow: 0px 5px 6px -3px rgba(0, 0, 0, 0.2), 0px 9px 12px 1px rgba(0, 0, 0, 0.14), 0px 3px 16px 2px rgba(0, 0, 0, 0.12); }\n\n.mat-elevation-z10 {\n  box-shadow: 0px 6px 6px -3px rgba(0, 0, 0, 0.2), 0px 10px 14px 1px rgba(0, 0, 0, 0.14), 0px 4px 18px 3px rgba(0, 0, 0, 0.12); }\n\n.mat-elevation-z11 {\n  box-shadow: 0px 6px 7px -4px rgba(0, 0, 0, 0.2), 0px 11px 15px 1px rgba(0, 0, 0, 0.14), 0px 4px 20px 3px rgba(0, 0, 0, 0.12); }\n\n.mat-elevation-z12 {\n  box-shadow: 0px 7px 8px -4px rgba(0, 0, 0, 0.2), 0px 12px 17px 2px rgba(0, 0, 0, 0.14), 0px 5px 22px 4px rgba(0, 0, 0, 0.12); }\n\n.mat-elevation-z13 {\n  box-shadow: 0px 7px 8px -4px rgba(0, 0, 0, 0.2), 0px 13px 19px 2px rgba(0, 0, 0, 0.14), 0px 5px 24px 4px rgba(0, 0, 0, 0.12); }\n\n.mat-elevation-z14 {\n  box-shadow: 0px 7px 9px -4px rgba(0, 0, 0, 0.2), 0px 14px 21px 2px rgba(0, 0, 0, 0.14), 0px 5px 26px 4px rgba(0, 0, 0, 0.12); }\n\n.mat-elevation-z15 {\n  box-shadow: 0px 8px 9px -5px rgba(0, 0, 0, 0.2), 0px 15px 22px 2px rgba(0, 0, 0, 0.14), 0px 6px 28px 5px rgba(0, 0, 0, 0.12); }\n\n.mat-elevation-z16 {\n  box-shadow: 0px 8px 10px -5px rgba(0, 0, 0, 0.2), 0px 16px 24px 2px rgba(0, 0, 0, 0.14), 0px 6px 30px 5px rgba(0, 0, 0, 0.12); }\n\n.mat-elevation-z17 {\n  box-shadow: 0px 8px 11px -5px rgba(0, 0, 0, 0.2), 0px 17px 26px 2px rgba(0, 0, 0, 0.14), 0px 6px 32px 5px rgba(0, 0, 0, 0.12); }\n\n.mat-elevation-z18 {\n  box-shadow: 0px 9px 11px -5px rgba(0, 0, 0, 0.2), 0px 18px 28px 2px rgba(0, 0, 0, 0.14), 0px 7px 34px 6px rgba(0, 0, 0, 0.12); }\n\n.mat-elevation-z19 {\n  box-shadow: 0px 9px 12px -6px rgba(0, 0, 0, 0.2), 0px 19px 29px 2px rgba(0, 0, 0, 0.14), 0px 7px 36px 6px rgba(0, 0, 0, 0.12); }\n\n.mat-elevation-z20 {\n  box-shadow: 0px 10px 13px -6px rgba(0, 0, 0, 0.2), 0px 20px 31px 3px rgba(0, 0, 0, 0.14), 0px 8px 38px 7px rgba(0, 0, 0, 0.12); }\n\n.mat-elevation-z21 {\n  box-shadow: 0px 10px 13px -6px rgba(0, 0, 0, 0.2), 0px 21px 33px 3px rgba(0, 0, 0, 0.14), 0px 8px 40px 7px rgba(0, 0, 0, 0.12); }\n\n.mat-elevation-z22 {\n  box-shadow: 0px 10px 14px -6px rgba(0, 0, 0, 0.2), 0px 22px 35px 3px rgba(0, 0, 0, 0.14), 0px 8px 42px 7px rgba(0, 0, 0, 0.12); }\n\n.mat-elevation-z23 {\n  box-shadow: 0px 11px 14px -7px rgba(0, 0, 0, 0.2), 0px 23px 36px 3px rgba(0, 0, 0, 0.14), 0px 9px 44px 8px rgba(0, 0, 0, 0.12); }\n\n.mat-elevation-z24 {\n  box-shadow: 0px 11px 15px -7px rgba(0, 0, 0, 0.2), 0px 24px 38px 3px rgba(0, 0, 0, 0.14), 0px 9px 46px 8px rgba(0, 0, 0, 0.12); }\n\n.mat-ripple {\n  overflow: hidden; }\n\n.mat-ripple.mat-ripple-unbounded {\n  overflow: visible; }\n\n.mat-ripple-element {\n  position: absolute;\n  border-radius: 50%;\n  pointer-events: none;\n  background-color: rgba(0, 0, 0, 0.1);\n  -webkit-transition: opacity, -webkit-transform 0ms cubic-bezier(0, 0, 0.2, 1);\n  transition: opacity, -webkit-transform 0ms cubic-bezier(0, 0, 0.2, 1);\n  transition: opacity, transform 0ms cubic-bezier(0, 0, 0.2, 1);\n  transition: opacity, transform 0ms cubic-bezier(0, 0, 0.2, 1), -webkit-transform 0ms cubic-bezier(0, 0, 0.2, 1);\n  -webkit-transform: scale(0);\n          transform: scale(0); }\n\n.mat-option {\n  white-space: nowrap;\n  overflow-x: hidden;\n  text-overflow: ellipsis;\n  display: block;\n  line-height: 48px;\n  height: 48px;\n  padding: 0 16px;\n  font-size: 16px;\n  font-family: Roboto, \"Helvetica Neue\", sans-serif;\n  text-align: start;\n  text-decoration: none;\n  position: relative;\n  cursor: pointer;\n  outline: none; }\n  .mat-option[disabled] {\n    cursor: default; }\n  .mat-option .mat-icon {\n    margin-right: 16px; }\n    [dir='rtl'] .mat-option .mat-icon {\n      margin-left: 16px; }\n  .mat-option[aria-disabled='true'] {\n    cursor: default;\n    -webkit-user-select: none;\n       -moz-user-select: none;\n        -ms-user-select: none;\n            user-select: none; }\n\n.mat-option-ripple {\n  position: absolute;\n  top: 0;\n  left: 0;\n  bottom: 0;\n  right: 0; }\n  @media screen and (-ms-high-contrast: active) {\n    .mat-option-ripple {\n      opacity: 0.5; } }\n\n.cdk-visually-hidden {\n  border: 0;\n  clip: rect(0 0 0 0);\n  height: 1px;\n  margin: -1px;\n  overflow: hidden;\n  padding: 0;\n  position: absolute;\n  text-transform: none;\n  width: 1px; }\n\n.cdk-overlay-container, .cdk-global-overlay-wrapper {\n  pointer-events: none;\n  top: 0;\n  left: 0;\n  height: 100%;\n  width: 100%; }\n\n.cdk-overlay-container {\n  position: fixed;\n  z-index: 1000; }\n\n.cdk-global-overlay-wrapper {\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  position: absolute;\n  z-index: 1000; }\n\n.cdk-overlay-pane {\n  position: absolute;\n  pointer-events: auto;\n  box-sizing: border-box;\n  z-index: 1000; }\n\n.cdk-overlay-backdrop {\n  position: absolute;\n  top: 0;\n  bottom: 0;\n  left: 0;\n  right: 0;\n  z-index: 1000;\n  pointer-events: auto;\n  -webkit-transition: opacity 400ms cubic-bezier(0.25, 0.8, 0.25, 1);\n  transition: opacity 400ms cubic-bezier(0.25, 0.8, 0.25, 1);\n  opacity: 0; }\n  .cdk-overlay-backdrop.cdk-overlay-backdrop-showing {\n    opacity: 0.48; }\n\n.cdk-overlay-dark-backdrop {\n  background: rgba(0, 0, 0, 0.6); }\n\n.cdk-overlay-transparent-backdrop {\n  background: none; }\n\n.mat-option:hover:not(.mat-option-disabled), .mat-option:focus:not(.mat-option-disabled) {\n  background: rgba(0, 0, 0, 0.04); }\n\n.mat-option.mat-selected {\n  background: rgba(0, 0, 0, 0.04);\n  color: #455a64; }\n\n.mat-option.mat-active {\n  background: rgba(0, 0, 0, 0.04);\n  color: rgba(0, 0, 0, 0.87); }\n\n.mat-option.mat-option-disabled {\n  color: rgba(0, 0, 0, 0.38); }\n\n.mat-pseudo-checkbox::after {\n  color: #fafafa; }\n\n.mat-pseudo-checkbox-checked, .mat-pseudo-checkbox-indeterminate {\n  border: none; }\n  .mat-pseudo-checkbox-checked.mat-primary, .mat-pseudo-checkbox-indeterminate.mat-primary {\n    background: #607d8b; }\n  .mat-pseudo-checkbox-checked.mat-accent, .mat-pseudo-checkbox-indeterminate.mat-accent {\n    background: #8bc34a; }\n  .mat-pseudo-checkbox-checked.mat-warn, .mat-pseudo-checkbox-indeterminate.mat-warn {\n    background: #f44336; }\n  .mat-pseudo-checkbox-checked.mat-pseudo-checkbox-disabled, .mat-pseudo-checkbox-indeterminate.mat-pseudo-checkbox-disabled {\n    background: #b0b0b0; }\n\n.mat-app-background {\n  background-color: #fafafa; }\n\n.mat-autocomplete-panel {\n  background: white;\n  color: rgba(0, 0, 0, 0.87); }\n  .mat-autocomplete-panel .mat-option.mat-selected:not(.mat-active) {\n    background: white;\n    color: rgba(0, 0, 0, 0.87); }\n\n.mat-button.mat-button-focus.mat-primary .mat-button-focus-overlay, .mat-icon-button.mat-button-focus.mat-primary .mat-button-focus-overlay, .mat-raised-button.mat-button-focus.mat-primary .mat-button-focus-overlay, .mat-fab.mat-button-focus.mat-primary .mat-button-focus-overlay, .mat-mini-fab.mat-button-focus.mat-primary .mat-button-focus-overlay {\n  background-color: rgba(69, 90, 100, 0.12); }\n\n.mat-button.mat-button-focus.mat-accent .mat-button-focus-overlay, .mat-icon-button.mat-button-focus.mat-accent .mat-button-focus-overlay, .mat-raised-button.mat-button-focus.mat-accent .mat-button-focus-overlay, .mat-fab.mat-button-focus.mat-accent .mat-button-focus-overlay, .mat-mini-fab.mat-button-focus.mat-accent .mat-button-focus-overlay {\n  background-color: rgba(139, 195, 74, 0.12); }\n\n.mat-button.mat-button-focus.mat-warn .mat-button-focus-overlay, .mat-icon-button.mat-button-focus.mat-warn .mat-button-focus-overlay, .mat-raised-button.mat-button-focus.mat-warn .mat-button-focus-overlay, .mat-fab.mat-button-focus.mat-warn .mat-button-focus-overlay, .mat-mini-fab.mat-button-focus.mat-warn .mat-button-focus-overlay {\n  background-color: rgba(213, 0, 0, 0.12); }\n\n.mat-button, .mat-icon-button {\n  background: transparent; }\n  .mat-button.mat-primary, .mat-icon-button.mat-primary {\n    color: #455a64; }\n  .mat-button.mat-accent, .mat-icon-button.mat-accent {\n    color: #8bc34a; }\n  .mat-button.mat-warn, .mat-icon-button.mat-warn {\n    color: #d50000; }\n  .mat-button.mat-primary[disabled], .mat-button.mat-accent[disabled], .mat-button.mat-warn[disabled], .mat-button[disabled][disabled], .mat-icon-button.mat-primary[disabled], .mat-icon-button.mat-accent[disabled], .mat-icon-button.mat-warn[disabled], .mat-icon-button[disabled][disabled] {\n    color: rgba(0, 0, 0, 0.38); }\n  .mat-button:hover.mat-primary .mat-button-focus-overlay, .mat-icon-button:hover.mat-primary .mat-button-focus-overlay {\n    background-color: rgba(69, 90, 100, 0.12); }\n  .mat-button:hover.mat-accent .mat-button-focus-overlay, .mat-icon-button:hover.mat-accent .mat-button-focus-overlay {\n    background-color: rgba(139, 195, 74, 0.12); }\n  .mat-button:hover.mat-warn .mat-button-focus-overlay, .mat-icon-button:hover.mat-warn .mat-button-focus-overlay {\n    background-color: rgba(213, 0, 0, 0.12); }\n\n.mat-raised-button, .mat-fab, .mat-mini-fab {\n  color: rgba(0, 0, 0, 0.87);\n  background-color: white; }\n  .mat-raised-button.mat-primary, .mat-fab.mat-primary, .mat-mini-fab.mat-primary {\n    color: rgba(255, 255, 255, 0.87); }\n  .mat-raised-button.mat-accent, .mat-fab.mat-accent, .mat-mini-fab.mat-accent {\n    color: rgba(0, 0, 0, 0.87); }\n  .mat-raised-button.mat-warn, .mat-fab.mat-warn, .mat-mini-fab.mat-warn {\n    color: white; }\n  .mat-raised-button.mat-primary[disabled], .mat-raised-button.mat-accent[disabled], .mat-raised-button.mat-warn[disabled], .mat-raised-button[disabled][disabled], .mat-fab.mat-primary[disabled], .mat-fab.mat-accent[disabled], .mat-fab.mat-warn[disabled], .mat-fab[disabled][disabled], .mat-mini-fab.mat-primary[disabled], .mat-mini-fab.mat-accent[disabled], .mat-mini-fab.mat-warn[disabled], .mat-mini-fab[disabled][disabled] {\n    color: rgba(0, 0, 0, 0.38); }\n  .mat-raised-button.mat-primary, .mat-fab.mat-primary, .mat-mini-fab.mat-primary {\n    background-color: #455a64; }\n  .mat-raised-button.mat-accent, .mat-fab.mat-accent, .mat-mini-fab.mat-accent {\n    background-color: #8bc34a; }\n  .mat-raised-button.mat-warn, .mat-fab.mat-warn, .mat-mini-fab.mat-warn {\n    background-color: #d50000; }\n  .mat-raised-button.mat-primary[disabled], .mat-raised-button.mat-accent[disabled], .mat-raised-button.mat-warn[disabled], .mat-raised-button[disabled][disabled], .mat-fab.mat-primary[disabled], .mat-fab.mat-accent[disabled], .mat-fab.mat-warn[disabled], .mat-fab[disabled][disabled], .mat-mini-fab.mat-primary[disabled], .mat-mini-fab.mat-accent[disabled], .mat-mini-fab.mat-warn[disabled], .mat-mini-fab[disabled][disabled] {\n    background-color: rgba(0, 0, 0, 0.12); }\n\n.mat-fab, .mat-mini-fab {\n  background-color: #8bc34a;\n  color: rgba(0, 0, 0, 0.87); }\n\n.mat-button-toggle {\n  color: rgba(0, 0, 0, 0.38); }\n\n.mat-button-toggle-checked {\n  background-color: #e0e0e0;\n  color: black; }\n\n.mat-button-toggle-disabled {\n  background-color: #eeeeee;\n  color: rgba(0, 0, 0, 0.38); }\n  .mat-button-toggle-disabled.mat-button-toggle-checked {\n    background-color: #bdbdbd; }\n\n.mat-card {\n  background: white;\n  color: black; }\n\n.mat-card-subtitle {\n  color: rgba(0, 0, 0, 0.54); }\n\n.mat-checkbox-frame {\n  border-color: rgba(0, 0, 0, 0.54); }\n\n.mat-checkbox-checkmark {\n  fill: #fafafa; }\n\n.mat-checkbox-checkmark-path {\n  stroke: #fafafa !important; }\n\n.mat-checkbox-mixedmark {\n  background-color: #fafafa; }\n\n.mat-checkbox-indeterminate.mat-primary .mat-checkbox-background, .mat-checkbox-checked.mat-primary .mat-checkbox-background {\n  background-color: #607d8b; }\n\n.mat-checkbox-indeterminate.mat-accent .mat-checkbox-background, .mat-checkbox-checked.mat-accent .mat-checkbox-background {\n  background-color: #8bc34a; }\n\n.mat-checkbox-indeterminate.mat-warn .mat-checkbox-background, .mat-checkbox-checked.mat-warn .mat-checkbox-background {\n  background-color: #f44336; }\n\n.mat-checkbox-disabled.mat-checkbox-checked .mat-checkbox-background, .mat-checkbox-disabled.mat-checkbox-indeterminate .mat-checkbox-background {\n  background-color: #b0b0b0; }\n\n.mat-checkbox-disabled:not(.mat-checkbox-checked) .mat-checkbox-frame {\n  border-color: #b0b0b0; }\n\n.mat-checkbox:not(.mat-checkbox-disabled).mat-primary .mat-checkbox-ripple .mat-ripple-element {\n  background-color: rgba(69, 90, 100, 0.26); }\n\n.mat-checkbox:not(.mat-checkbox-disabled).mat-accent .mat-checkbox-ripple .mat-ripple-element {\n  background-color: rgba(139, 195, 74, 0.26); }\n\n.mat-checkbox:not(.mat-checkbox-disabled).mat-warn .mat-checkbox-ripple .mat-ripple-element {\n  background-color: rgba(213, 0, 0, 0.26); }\n\n.mat-chip:not(.mat-basic-chip) {\n  background-color: #e0e0e0;\n  color: rgba(0, 0, 0, 0.87); }\n\n.mat-chip.mat-chip-selected:not(.mat-basic-chip) {\n  background-color: #808080;\n  color: rgba(255, 255, 255, 0.87); }\n  .mat-chip.mat-chip-selected:not(.mat-basic-chip).mat-primary {\n    background-color: #607d8b;\n    color: white; }\n  .mat-chip.mat-chip-selected:not(.mat-basic-chip).mat-accent {\n    background-color: #8bc34a;\n    color: rgba(0, 0, 0, 0.87); }\n  .mat-chip.mat-chip-selected:not(.mat-basic-chip).mat-warn {\n    background-color: #f44336;\n    color: white; }\n\n.mat-dialog-container {\n  background: white; }\n\n.mat-icon.mat-primary {\n  color: #455a64; }\n\n.mat-icon.mat-accent {\n  color: #8bc34a; }\n\n.mat-icon.mat-warn {\n  color: #d50000; }\n\n.mat-input-placeholder {\n  color: rgba(0, 0, 0, 0.38); }\n  .mat-input-placeholder.mat-focused {\n    color: #455a64; }\n    .mat-input-placeholder.mat-focused.mat-accent {\n      color: #8bc34a; }\n    .mat-input-placeholder.mat-focused.mat-warn {\n      color: #d50000; }\n\n.mat-input-element:disabled {\n  color: rgba(0, 0, 0, 0.38); }\n\ninput.mat-input-element:-webkit-autofill + .mat-input-placeholder .mat-placeholder-required,\n.mat-input-placeholder.mat-float.mat-focused .mat-placeholder-required {\n  color: #8bc34a; }\n\n.mat-input-underline {\n  border-color: rgba(0, 0, 0, 0.12); }\n  .mat-input-underline .mat-input-ripple {\n    background-color: #455a64; }\n    .mat-input-underline .mat-input-ripple.mat-accent {\n      background-color: #8bc34a; }\n    .mat-input-underline .mat-input-ripple.mat-warn {\n      background-color: #d50000; }\n\n.mat-list .mat-list-item, .mat-nav-list .mat-list-item {\n  color: black; }\n\n.mat-list .mat-subheader, .mat-nav-list .mat-subheader {\n  color: rgba(0, 0, 0, 0.54); }\n\n.mat-divider {\n  border-top-color: rgba(0, 0, 0, 0.12); }\n\n.mat-nav-list .mat-list-item-content:hover, .mat-nav-list .mat-list-item-content.mat-list-item-focus {\n  background: rgba(0, 0, 0, 0.04); }\n\n.mat-menu-content {\n  background: white; }\n\n.mat-menu-item {\n  background: transparent;\n  color: rgba(0, 0, 0, 0.87); }\n  .mat-menu-item[disabled] {\n    color: rgba(0, 0, 0, 0.38); }\n  .mat-menu-item .mat-icon {\n    color: rgba(0, 0, 0, 0.54);\n    vertical-align: middle; }\n  .mat-menu-item:hover:not([disabled]), .mat-menu-item:focus:not([disabled]) {\n    background: rgba(0, 0, 0, 0.04); }\n\n.mat-progress-bar-background {\n  background: url(\"data:image/svg+xml;charset=UTF-8,%3Csvg%20version%3D%271.1%27%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20xmlns%3Axlink%3D%27http%3A%2F%2Fwww.w3.org%2F1999%2Fxlink%27%20x%3D%270px%27%20y%3D%270px%27%20enable-background%3D%27new%200%200%205%202%27%20xml%3Aspace%3D%27preserve%27%20viewBox%3D%270%200%205%202%27%20preserveAspectRatio%3D%27none%20slice%27%3E%3Ccircle%20cx%3D%271%27%20cy%3D%271%27%20r%3D%271%27%20fill%3D%27%23cfd8dc%27%2F%3E%3C%2Fsvg%3E\"); }\n\n.mat-progress-bar-buffer {\n  background-color: #cfd8dc; }\n\n.mat-progress-bar-fill::after {\n  background-color: #546e7a; }\n\n.mat-progress-bar.mat-accent .mat-progress-bar-background {\n  background: url(\"data:image/svg+xml;charset=UTF-8,%3Csvg%20version%3D%271.1%27%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20xmlns%3Axlink%3D%27http%3A%2F%2Fwww.w3.org%2F1999%2Fxlink%27%20x%3D%270px%27%20y%3D%270px%27%20enable-background%3D%27new%200%200%205%202%27%20xml%3Aspace%3D%27preserve%27%20viewBox%3D%270%200%205%202%27%20preserveAspectRatio%3D%27none%20slice%27%3E%3Ccircle%20cx%3D%271%27%20cy%3D%271%27%20r%3D%271%27%20fill%3D%27%23dcedc8%27%2F%3E%3C%2Fsvg%3E\"); }\n\n.mat-progress-bar.mat-accent .mat-progress-bar-buffer {\n  background-color: #dcedc8; }\n\n.mat-progress-bar.mat-accent .mat-progress-bar-fill::after {\n  background-color: #7cb342; }\n\n.mat-progress-bar.mat-warn .mat-progress-bar-background {\n  background: url(\"data:image/svg+xml;charset=UTF-8,%3Csvg%20version%3D%271.1%27%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20xmlns%3Axlink%3D%27http%3A%2F%2Fwww.w3.org%2F1999%2Fxlink%27%20x%3D%270px%27%20y%3D%270px%27%20enable-background%3D%27new%200%200%205%202%27%20xml%3Aspace%3D%27preserve%27%20viewBox%3D%270%200%205%202%27%20preserveAspectRatio%3D%27none%20slice%27%3E%3Ccircle%20cx%3D%271%27%20cy%3D%271%27%20r%3D%271%27%20fill%3D%27%23ffcdd2%27%2F%3E%3C%2Fsvg%3E\"); }\n\n.mat-progress-bar.mat-warn .mat-progress-bar-buffer {\n  background-color: #ffcdd2; }\n\n.mat-progress-bar.mat-warn .mat-progress-bar-fill::after {\n  background-color: #e53935; }\n\n.mat-progress-spinner path, .mat-progress-circle path, .mat-spinner path {\n  stroke: #546e7a; }\n\n.mat-progress-spinner.mat-accent path, .mat-progress-circle.mat-accent path, .mat-spinner.mat-accent path {\n  stroke: #7cb342; }\n\n.mat-progress-spinner.mat-warn path, .mat-progress-circle.mat-warn path, .mat-spinner.mat-warn path {\n  stroke: #e53935; }\n\n.mat-radio-outer-circle {\n  border-color: rgba(0, 0, 0, 0.54); }\n  .mat-radio-checked .mat-radio-outer-circle {\n    border-color: #8bc34a; }\n  .mat-radio-disabled .mat-radio-outer-circle {\n    border-color: rgba(0, 0, 0, 0.38); }\n\n.mat-radio-inner-circle {\n  background-color: #8bc34a; }\n  .mat-radio-disabled .mat-radio-inner-circle {\n    background-color: rgba(0, 0, 0, 0.38); }\n\n.mat-radio-ripple .mat-ripple-element {\n  background-color: rgba(139, 195, 74, 0.26); }\n  .mat-radio-disabled .mat-radio-ripple .mat-ripple-element {\n    background-color: rgba(0, 0, 0, 0.38); }\n\n.mat-select-trigger {\n  color: rgba(0, 0, 0, 0.38); }\n  .mat-select:focus:not(.mat-select-disabled) .mat-select-trigger {\n    color: #455a64; }\n  .mat-select.ng-invalid.ng-touched:not(.mat-select-disabled) .mat-select-trigger {\n    color: #d50000; }\n\n.mat-select-underline {\n  background-color: rgba(0, 0, 0, 0.12); }\n  .mat-select:focus:not(.mat-select-disabled) .mat-select-underline {\n    background-color: #455a64; }\n  .mat-select.ng-invalid.ng-touched:not(.mat-select-disabled) .mat-select-underline {\n    background-color: #d50000; }\n\n.mat-select-arrow {\n  color: rgba(0, 0, 0, 0.38); }\n  .mat-select:focus:not(.mat-select-disabled) .mat-select-arrow {\n    color: #455a64; }\n  .mat-select.ng-invalid.ng-touched:not(.mat-select-disabled) .mat-select-arrow {\n    color: #d50000; }\n\n.mat-select-content, .mat-select-panel-done-animating {\n  background: white; }\n\n.mat-select-value {\n  color: rgba(0, 0, 0, 0.87); }\n  .mat-select-disabled .mat-select-value {\n    color: rgba(0, 0, 0, 0.38); }\n\n.mat-sidenav-container {\n  background-color: #fafafa;\n  color: rgba(0, 0, 0, 0.87); }\n\n.mat-sidenav {\n  background-color: white;\n  color: rgba(0, 0, 0, 0.87); }\n  .mat-sidenav.mat-sidenav-push {\n    background-color: white; }\n\n.mat-sidenav-backdrop.mat-sidenav-shown {\n  background-color: rgba(0, 0, 0, 0.6); }\n\n.mat-slide-toggle.mat-checked:not(.mat-disabled) .mat-slide-toggle-thumb {\n  background-color: #8bc34a; }\n\n.mat-slide-toggle.mat-checked:not(.mat-disabled) .mat-slide-toggle-bar {\n  background-color: rgba(139, 195, 74, 0.5); }\n\n.mat-slide-toggle.mat-slide-toggle-focused:not(.mat-checked) .mat-ink-ripple {\n  background-color: rgba(0, 0, 0, 0.12); }\n\n.mat-slide-toggle.mat-slide-toggle-focused .mat-ink-ripple {\n  background-color: rgba(139, 195, 74, 0.26); }\n\n.mat-slide-toggle.mat-primary.mat-checked:not(.mat-disabled) .mat-slide-toggle-thumb {\n  background-color: #607d8b; }\n\n.mat-slide-toggle.mat-primary.mat-checked:not(.mat-disabled) .mat-slide-toggle-bar {\n  background-color: rgba(96, 125, 139, 0.5); }\n\n.mat-slide-toggle.mat-primary.mat-slide-toggle-focused:not(.mat-checked) .mat-ink-ripple {\n  background-color: rgba(0, 0, 0, 0.12); }\n\n.mat-slide-toggle.mat-primary.mat-slide-toggle-focused .mat-ink-ripple {\n  background-color: rgba(96, 125, 139, 0.26); }\n\n.mat-slide-toggle.mat-warn.mat-checked:not(.mat-disabled) .mat-slide-toggle-thumb {\n  background-color: #f44336; }\n\n.mat-slide-toggle.mat-warn.mat-checked:not(.mat-disabled) .mat-slide-toggle-bar {\n  background-color: rgba(244, 67, 54, 0.5); }\n\n.mat-slide-toggle.mat-warn.mat-slide-toggle-focused:not(.mat-checked) .mat-ink-ripple {\n  background-color: rgba(0, 0, 0, 0.12); }\n\n.mat-slide-toggle.mat-warn.mat-slide-toggle-focused .mat-ink-ripple {\n  background-color: rgba(244, 67, 54, 0.26); }\n\n.mat-disabled .mat-slide-toggle-thumb {\n  background-color: #bdbdbd; }\n\n.mat-disabled .mat-slide-toggle-bar {\n  background-color: rgba(0, 0, 0, 0.1); }\n\n.mat-slide-toggle-thumb {\n  background-color: #fafafa; }\n\n.mat-slide-toggle-bar {\n  background-color: rgba(0, 0, 0, 0.38); }\n\n.mat-slider-track-background {\n  background-color: rgba(0, 0, 0, 0.26); }\n\n.mat-slider-track-fill {\n  background-color: #8bc34a; }\n\n.mat-slider-thumb {\n  background-color: #8bc34a; }\n\n.mat-slider-thumb-label {\n  background-color: #8bc34a; }\n\n.mat-slider-thumb-label-text {\n  color: rgba(0, 0, 0, 0.87); }\n\n.mat-slider:hover .mat-slider-track-background,\n.mat-slider-active .mat-slider-track-background {\n  background-color: rgba(0, 0, 0, 0.38); }\n\n.mat-slider-disabled .mat-slider-track-background,\n.mat-slider-disabled .mat-slider-track-fill,\n.mat-slider-disabled .mat-slider-thumb {\n  background-color: rgba(0, 0, 0, 0.26); }\n\n.mat-slider-disabled:hover .mat-slider-track-background {\n  background-color: rgba(0, 0, 0, 0.26); }\n\n.mat-slider-min-value.mat-slider-thumb-label-showing .mat-slider-thumb,\n.mat-slider-min-value.mat-slider-thumb-label-showing .mat-slider-thumb-label {\n  background-color: black; }\n\n.mat-slider-min-value.mat-slider-thumb-label-showing.mat-slider-active .mat-slider-thumb,\n.mat-slider-min-value.mat-slider-thumb-label-showing.mat-slider-active .mat-slider-thumb-label {\n  background-color: rgba(0, 0, 0, 0.26); }\n\n.mat-slider-min-value:not(.mat-slider-thumb-label-showing) .mat-slider-thumb {\n  border-color: rgba(0, 0, 0, 0.26);\n  background-color: transparent; }\n\n.mat-slider-min-value:not(.mat-slider-thumb-label-showing):hover .mat-slider-thumb, .mat-slider-min-value:not(.mat-slider-thumb-label-showing).mat-slider-active .mat-slider-thumb {\n  border-color: rgba(0, 0, 0, 0.38); }\n\n.mat-slider-min-value:not(.mat-slider-thumb-label-showing):hover.mat-slider-disabled .mat-slider-thumb, .mat-slider-min-value:not(.mat-slider-thumb-label-showing).mat-slider-active.mat-slider-disabled .mat-slider-thumb {\n  border-color: rgba(0, 0, 0, 0.26); }\n\n.mat-tab-nav-bar,\n.mat-tab-header {\n  border-bottom: 1px solid #e0e0e0; }\n  .mat-tab-group-inverted-header .mat-tab-nav-bar, .mat-tab-group-inverted-header\n  .mat-tab-header {\n    border-top: 1px solid #e0e0e0;\n    border-bottom: none; }\n\n.mat-tab-label:focus {\n  background-color: rgba(207, 216, 220, 0.3); }\n\n.mat-ink-bar {\n  background-color: #607d8b; }\n\n.mat-toolbar {\n  background: whitesmoke;\n  color: rgba(0, 0, 0, 0.87); }\n  .mat-toolbar.mat-primary {\n    background: #455a64;\n    color: rgba(255, 255, 255, 0.87); }\n  .mat-toolbar.mat-accent {\n    background: #8bc34a;\n    color: rgba(0, 0, 0, 0.87); }\n  .mat-toolbar.mat-warn {\n    background: #d50000;\n    color: white; }\n\n.mat-tooltip {\n  background: rgba(97, 97, 97, 0.9); }\n\n.bp-dark-theme .mat-option:hover:not(.mat-option-disabled), .bp-dark-theme .mat-option:focus:not(.mat-option-disabled) {\n  background: rgba(255, 255, 255, 0.04); }\n\n.bp-dark-theme .mat-option.mat-selected {\n  background: rgba(255, 255, 255, 0.04);\n  color: #616161; }\n\n.bp-dark-theme .mat-option.mat-active {\n  background: rgba(255, 255, 255, 0.04);\n  color: white; }\n\n.bp-dark-theme .mat-option.mat-option-disabled {\n  color: rgba(255, 255, 255, 0.3); }\n\n.bp-dark-theme .mat-pseudo-checkbox::after {\n  color: #303030; }\n\n.bp-dark-theme .mat-pseudo-checkbox-checked, .bp-dark-theme .mat-pseudo-checkbox-indeterminate {\n  border: none; }\n  .bp-dark-theme .mat-pseudo-checkbox-checked.mat-primary, .bp-dark-theme .mat-pseudo-checkbox-indeterminate.mat-primary {\n    background: #9e9e9e; }\n  .bp-dark-theme .mat-pseudo-checkbox-checked.mat-accent, .bp-dark-theme .mat-pseudo-checkbox-indeterminate.mat-accent {\n    background: #ffc107; }\n  .bp-dark-theme .mat-pseudo-checkbox-checked.mat-warn, .bp-dark-theme .mat-pseudo-checkbox-indeterminate.mat-warn {\n    background: #ff5722; }\n  .bp-dark-theme .mat-pseudo-checkbox-checked.mat-pseudo-checkbox-disabled, .bp-dark-theme .mat-pseudo-checkbox-indeterminate.mat-pseudo-checkbox-disabled {\n    background: #686868; }\n\n.bp-dark-theme .mat-app-background {\n  background-color: #303030; }\n\n.bp-dark-theme .mat-autocomplete-panel {\n  background: #424242;\n  color: white; }\n  .bp-dark-theme .mat-autocomplete-panel .mat-option.mat-selected:not(.mat-active) {\n    background: #424242;\n    color: white; }\n\n.bp-dark-theme .mat-button.mat-button-focus.mat-primary .mat-button-focus-overlay, .bp-dark-theme .mat-icon-button.mat-button-focus.mat-primary .mat-button-focus-overlay, .bp-dark-theme .mat-raised-button.mat-button-focus.mat-primary .mat-button-focus-overlay, .bp-dark-theme .mat-fab.mat-button-focus.mat-primary .mat-button-focus-overlay, .bp-dark-theme .mat-mini-fab.mat-button-focus.mat-primary .mat-button-focus-overlay {\n  background-color: rgba(97, 97, 97, 0.12); }\n\n.bp-dark-theme .mat-button.mat-button-focus.mat-accent .mat-button-focus-overlay, .bp-dark-theme .mat-icon-button.mat-button-focus.mat-accent .mat-button-focus-overlay, .bp-dark-theme .mat-raised-button.mat-button-focus.mat-accent .mat-button-focus-overlay, .bp-dark-theme .mat-fab.mat-button-focus.mat-accent .mat-button-focus-overlay, .bp-dark-theme .mat-mini-fab.mat-button-focus.mat-accent .mat-button-focus-overlay {\n  background-color: rgba(255, 196, 0, 0.12); }\n\n.bp-dark-theme .mat-button.mat-button-focus.mat-warn .mat-button-focus-overlay, .bp-dark-theme .mat-icon-button.mat-button-focus.mat-warn .mat-button-focus-overlay, .bp-dark-theme .mat-raised-button.mat-button-focus.mat-warn .mat-button-focus-overlay, .bp-dark-theme .mat-fab.mat-button-focus.mat-warn .mat-button-focus-overlay, .bp-dark-theme .mat-mini-fab.mat-button-focus.mat-warn .mat-button-focus-overlay {\n  background-color: rgba(255, 87, 34, 0.12); }\n\n.bp-dark-theme .mat-button, .bp-dark-theme .mat-icon-button {\n  background: transparent; }\n  .bp-dark-theme .mat-button.mat-primary, .bp-dark-theme .mat-icon-button.mat-primary {\n    color: #616161; }\n  .bp-dark-theme .mat-button.mat-accent, .bp-dark-theme .mat-icon-button.mat-accent {\n    color: #ffc400; }\n  .bp-dark-theme .mat-button.mat-warn, .bp-dark-theme .mat-icon-button.mat-warn {\n    color: #ff5722; }\n  .bp-dark-theme .mat-button.mat-primary[disabled], .bp-dark-theme .mat-button.mat-accent[disabled], .bp-dark-theme .mat-button.mat-warn[disabled], .bp-dark-theme .mat-button[disabled][disabled], .bp-dark-theme .mat-icon-button.mat-primary[disabled], .bp-dark-theme .mat-icon-button.mat-accent[disabled], .bp-dark-theme .mat-icon-button.mat-warn[disabled], .bp-dark-theme .mat-icon-button[disabled][disabled] {\n    color: rgba(255, 255, 255, 0.3); }\n  .bp-dark-theme .mat-button:hover.mat-primary .mat-button-focus-overlay, .bp-dark-theme .mat-icon-button:hover.mat-primary .mat-button-focus-overlay {\n    background-color: rgba(97, 97, 97, 0.12); }\n  .bp-dark-theme .mat-button:hover.mat-accent .mat-button-focus-overlay, .bp-dark-theme .mat-icon-button:hover.mat-accent .mat-button-focus-overlay {\n    background-color: rgba(255, 196, 0, 0.12); }\n  .bp-dark-theme .mat-button:hover.mat-warn .mat-button-focus-overlay, .bp-dark-theme .mat-icon-button:hover.mat-warn .mat-button-focus-overlay {\n    background-color: rgba(255, 87, 34, 0.12); }\n\n.bp-dark-theme .mat-raised-button, .bp-dark-theme .mat-fab, .bp-dark-theme .mat-mini-fab {\n  color: white;\n  background-color: #424242; }\n  .bp-dark-theme .mat-raised-button.mat-primary, .bp-dark-theme .mat-fab.mat-primary, .bp-dark-theme .mat-mini-fab.mat-primary {\n    color: rgba(255, 255, 255, 0.87); }\n  .bp-dark-theme .mat-raised-button.mat-accent, .bp-dark-theme .mat-fab.mat-accent, .bp-dark-theme .mat-mini-fab.mat-accent {\n    color: rgba(0, 0, 0, 0.87); }\n  .bp-dark-theme .mat-raised-button.mat-warn, .bp-dark-theme .mat-fab.mat-warn, .bp-dark-theme .mat-mini-fab.mat-warn {\n    color: white; }\n  .bp-dark-theme .mat-raised-button.mat-primary[disabled], .bp-dark-theme .mat-raised-button.mat-accent[disabled], .bp-dark-theme .mat-raised-button.mat-warn[disabled], .bp-dark-theme .mat-raised-button[disabled][disabled], .bp-dark-theme .mat-fab.mat-primary[disabled], .bp-dark-theme .mat-fab.mat-accent[disabled], .bp-dark-theme .mat-fab.mat-warn[disabled], .bp-dark-theme .mat-fab[disabled][disabled], .bp-dark-theme .mat-mini-fab.mat-primary[disabled], .bp-dark-theme .mat-mini-fab.mat-accent[disabled], .bp-dark-theme .mat-mini-fab.mat-warn[disabled], .bp-dark-theme .mat-mini-fab[disabled][disabled] {\n    color: rgba(255, 255, 255, 0.3); }\n  .bp-dark-theme .mat-raised-button.mat-primary, .bp-dark-theme .mat-fab.mat-primary, .bp-dark-theme .mat-mini-fab.mat-primary {\n    background-color: #616161; }\n  .bp-dark-theme .mat-raised-button.mat-accent, .bp-dark-theme .mat-fab.mat-accent, .bp-dark-theme .mat-mini-fab.mat-accent {\n    background-color: #ffc400; }\n  .bp-dark-theme .mat-raised-button.mat-warn, .bp-dark-theme .mat-fab.mat-warn, .bp-dark-theme .mat-mini-fab.mat-warn {\n    background-color: #ff5722; }\n  .bp-dark-theme .mat-raised-button.mat-primary[disabled], .bp-dark-theme .mat-raised-button.mat-accent[disabled], .bp-dark-theme .mat-raised-button.mat-warn[disabled], .bp-dark-theme .mat-raised-button[disabled][disabled], .bp-dark-theme .mat-fab.mat-primary[disabled], .bp-dark-theme .mat-fab.mat-accent[disabled], .bp-dark-theme .mat-fab.mat-warn[disabled], .bp-dark-theme .mat-fab[disabled][disabled], .bp-dark-theme .mat-mini-fab.mat-primary[disabled], .bp-dark-theme .mat-mini-fab.mat-accent[disabled], .bp-dark-theme .mat-mini-fab.mat-warn[disabled], .bp-dark-theme .mat-mini-fab[disabled][disabled] {\n    background-color: rgba(255, 255, 255, 0.12); }\n\n.bp-dark-theme .mat-fab, .bp-dark-theme .mat-mini-fab {\n  background-color: #ffc400;\n  color: rgba(0, 0, 0, 0.87); }\n\n.bp-dark-theme .mat-button-toggle {\n  color: rgba(255, 255, 255, 0.3); }\n\n.bp-dark-theme .mat-button-toggle-checked {\n  background-color: #e0e0e0;\n  color: white; }\n\n.bp-dark-theme .mat-button-toggle-disabled {\n  background-color: #eeeeee;\n  color: rgba(255, 255, 255, 0.3); }\n  .bp-dark-theme .mat-button-toggle-disabled.mat-button-toggle-checked {\n    background-color: #bdbdbd; }\n\n.bp-dark-theme .mat-card {\n  background: #424242;\n  color: white; }\n\n.bp-dark-theme .mat-card-subtitle {\n  color: rgba(255, 255, 255, 0.7); }\n\n.bp-dark-theme .mat-checkbox-frame {\n  border-color: rgba(255, 255, 255, 0.7); }\n\n.bp-dark-theme .mat-checkbox-checkmark {\n  fill: #303030; }\n\n.bp-dark-theme .mat-checkbox-checkmark-path {\n  stroke: #303030 !important; }\n\n.bp-dark-theme .mat-checkbox-mixedmark {\n  background-color: #303030; }\n\n.bp-dark-theme .mat-checkbox-indeterminate.mat-primary .mat-checkbox-background, .bp-dark-theme .mat-checkbox-checked.mat-primary .mat-checkbox-background {\n  background-color: #9e9e9e; }\n\n.bp-dark-theme .mat-checkbox-indeterminate.mat-accent .mat-checkbox-background, .bp-dark-theme .mat-checkbox-checked.mat-accent .mat-checkbox-background {\n  background-color: #ffc107; }\n\n.bp-dark-theme .mat-checkbox-indeterminate.mat-warn .mat-checkbox-background, .bp-dark-theme .mat-checkbox-checked.mat-warn .mat-checkbox-background {\n  background-color: #ff5722; }\n\n.bp-dark-theme .mat-checkbox-disabled.mat-checkbox-checked .mat-checkbox-background, .bp-dark-theme .mat-checkbox-disabled.mat-checkbox-indeterminate .mat-checkbox-background {\n  background-color: #686868; }\n\n.bp-dark-theme .mat-checkbox-disabled:not(.mat-checkbox-checked) .mat-checkbox-frame {\n  border-color: #686868; }\n\n.bp-dark-theme .mat-checkbox:not(.mat-checkbox-disabled).mat-primary .mat-checkbox-ripple .mat-ripple-element {\n  background-color: rgba(97, 97, 97, 0.26); }\n\n.bp-dark-theme .mat-checkbox:not(.mat-checkbox-disabled).mat-accent .mat-checkbox-ripple .mat-ripple-element {\n  background-color: rgba(255, 196, 0, 0.26); }\n\n.bp-dark-theme .mat-checkbox:not(.mat-checkbox-disabled).mat-warn .mat-checkbox-ripple .mat-ripple-element {\n  background-color: rgba(255, 87, 34, 0.26); }\n\n.bp-dark-theme .mat-chip:not(.mat-basic-chip) {\n  background-color: #424242;\n  color: white; }\n\n.bp-dark-theme .mat-chip.mat-chip-selected:not(.mat-basic-chip) {\n  background-color: #212121;\n  color: white; }\n  .bp-dark-theme .mat-chip.mat-chip-selected:not(.mat-basic-chip).mat-primary {\n    background-color: #9e9e9e;\n    color: rgba(0, 0, 0, 0.87); }\n  .bp-dark-theme .mat-chip.mat-chip-selected:not(.mat-basic-chip).mat-accent {\n    background-color: #ffc107;\n    color: rgba(0, 0, 0, 0.87); }\n  .bp-dark-theme .mat-chip.mat-chip-selected:not(.mat-basic-chip).mat-warn {\n    background-color: #ff5722;\n    color: white; }\n\n.bp-dark-theme .mat-dialog-container {\n  background: #424242; }\n\n.bp-dark-theme .mat-icon.mat-primary {\n  color: #616161; }\n\n.bp-dark-theme .mat-icon.mat-accent {\n  color: #ffc400; }\n\n.bp-dark-theme .mat-icon.mat-warn {\n  color: #ff5722; }\n\n.bp-dark-theme .mat-input-placeholder {\n  color: rgba(255, 255, 255, 0.3); }\n  .bp-dark-theme .mat-input-placeholder.mat-focused {\n    color: #616161; }\n    .bp-dark-theme .mat-input-placeholder.mat-focused.mat-accent {\n      color: #ffc400; }\n    .bp-dark-theme .mat-input-placeholder.mat-focused.mat-warn {\n      color: #ff5722; }\n\n.bp-dark-theme .mat-input-element:disabled {\n  color: rgba(255, 255, 255, 0.3); }\n\n.bp-dark-theme input.mat-input-element:-webkit-autofill + .mat-input-placeholder .mat-placeholder-required,\n.bp-dark-theme .mat-input-placeholder.mat-float.mat-focused .mat-placeholder-required {\n  color: #ffc400; }\n\n.bp-dark-theme .mat-input-underline {\n  border-color: rgba(255, 255, 255, 0.12); }\n  .bp-dark-theme .mat-input-underline .mat-input-ripple {\n    background-color: #616161; }\n    .bp-dark-theme .mat-input-underline .mat-input-ripple.mat-accent {\n      background-color: #ffc400; }\n    .bp-dark-theme .mat-input-underline .mat-input-ripple.mat-warn {\n      background-color: #ff5722; }\n\n.bp-dark-theme .mat-list .mat-list-item, .bp-dark-theme .mat-nav-list .mat-list-item {\n  color: white; }\n\n.bp-dark-theme .mat-list .mat-subheader, .bp-dark-theme .mat-nav-list .mat-subheader {\n  color: rgba(255, 255, 255, 0.7); }\n\n.bp-dark-theme .mat-divider {\n  border-top-color: rgba(255, 255, 255, 0.12); }\n\n.bp-dark-theme .mat-nav-list .mat-list-item-content:hover, .bp-dark-theme .mat-nav-list .mat-list-item-content.mat-list-item-focus {\n  background: rgba(255, 255, 255, 0.04); }\n\n.bp-dark-theme .mat-menu-content {\n  background: #424242; }\n\n.bp-dark-theme .mat-menu-item {\n  background: transparent;\n  color: white; }\n  .bp-dark-theme .mat-menu-item[disabled] {\n    color: rgba(255, 255, 255, 0.3); }\n  .bp-dark-theme .mat-menu-item .mat-icon {\n    color: white;\n    vertical-align: middle; }\n  .bp-dark-theme .mat-menu-item:hover:not([disabled]), .bp-dark-theme .mat-menu-item:focus:not([disabled]) {\n    background: rgba(255, 255, 255, 0.04); }\n\n.bp-dark-theme .mat-progress-bar-background {\n  background: url(\"data:image/svg+xml;charset=UTF-8,%3Csvg%20version%3D%271.1%27%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20xmlns%3Axlink%3D%27http%3A%2F%2Fwww.w3.org%2F1999%2Fxlink%27%20x%3D%270px%27%20y%3D%270px%27%20enable-background%3D%27new%200%200%205%202%27%20xml%3Aspace%3D%27preserve%27%20viewBox%3D%270%200%205%202%27%20preserveAspectRatio%3D%27none%20slice%27%3E%3Ccircle%20cx%3D%271%27%20cy%3D%271%27%20r%3D%271%27%20fill%3D%27whitesmoke%27%2F%3E%3C%2Fsvg%3E\"); }\n\n.bp-dark-theme .mat-progress-bar-buffer {\n  background-color: whitesmoke; }\n\n.bp-dark-theme .mat-progress-bar-fill::after {\n  background-color: #757575; }\n\n.bp-dark-theme .mat-progress-bar.mat-accent .mat-progress-bar-background {\n  background: url(\"data:image/svg+xml;charset=UTF-8,%3Csvg%20version%3D%271.1%27%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20xmlns%3Axlink%3D%27http%3A%2F%2Fwww.w3.org%2F1999%2Fxlink%27%20x%3D%270px%27%20y%3D%270px%27%20enable-background%3D%27new%200%200%205%202%27%20xml%3Aspace%3D%27preserve%27%20viewBox%3D%270%200%205%202%27%20preserveAspectRatio%3D%27none%20slice%27%3E%3Ccircle%20cx%3D%271%27%20cy%3D%271%27%20r%3D%271%27%20fill%3D%27%23ffecb3%27%2F%3E%3C%2Fsvg%3E\"); }\n\n.bp-dark-theme .mat-progress-bar.mat-accent .mat-progress-bar-buffer {\n  background-color: #ffecb3; }\n\n.bp-dark-theme .mat-progress-bar.mat-accent .mat-progress-bar-fill::after {\n  background-color: #ffb300; }\n\n.bp-dark-theme .mat-progress-bar.mat-warn .mat-progress-bar-background {\n  background: url(\"data:image/svg+xml;charset=UTF-8,%3Csvg%20version%3D%271.1%27%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20xmlns%3Axlink%3D%27http%3A%2F%2Fwww.w3.org%2F1999%2Fxlink%27%20x%3D%270px%27%20y%3D%270px%27%20enable-background%3D%27new%200%200%205%202%27%20xml%3Aspace%3D%27preserve%27%20viewBox%3D%270%200%205%202%27%20preserveAspectRatio%3D%27none%20slice%27%3E%3Ccircle%20cx%3D%271%27%20cy%3D%271%27%20r%3D%271%27%20fill%3D%27%23ffccbc%27%2F%3E%3C%2Fsvg%3E\"); }\n\n.bp-dark-theme .mat-progress-bar.mat-warn .mat-progress-bar-buffer {\n  background-color: #ffccbc; }\n\n.bp-dark-theme .mat-progress-bar.mat-warn .mat-progress-bar-fill::after {\n  background-color: #f4511e; }\n\n.bp-dark-theme .mat-progress-spinner path, .bp-dark-theme .mat-progress-circle path, .bp-dark-theme .mat-spinner path {\n  stroke: #757575; }\n\n.bp-dark-theme .mat-progress-spinner.mat-accent path, .bp-dark-theme .mat-progress-circle.mat-accent path, .bp-dark-theme .mat-spinner.mat-accent path {\n  stroke: #ffb300; }\n\n.bp-dark-theme .mat-progress-spinner.mat-warn path, .bp-dark-theme .mat-progress-circle.mat-warn path, .bp-dark-theme .mat-spinner.mat-warn path {\n  stroke: #f4511e; }\n\n.bp-dark-theme .mat-radio-outer-circle {\n  border-color: rgba(255, 255, 255, 0.7); }\n  .mat-radio-checked .bp-dark-theme .mat-radio-outer-circle {\n    border-color: #ffc400; }\n  .mat-radio-disabled .bp-dark-theme .mat-radio-outer-circle {\n    border-color: rgba(255, 255, 255, 0.3); }\n\n.bp-dark-theme .mat-radio-inner-circle {\n  background-color: #ffc400; }\n  .mat-radio-disabled .bp-dark-theme .mat-radio-inner-circle {\n    background-color: rgba(255, 255, 255, 0.3); }\n\n.bp-dark-theme .mat-radio-ripple .mat-ripple-element {\n  background-color: rgba(255, 196, 0, 0.26); }\n  .mat-radio-disabled .bp-dark-theme .mat-radio-ripple .mat-ripple-element {\n    background-color: rgba(255, 255, 255, 0.3); }\n\n.bp-dark-theme .mat-select-trigger {\n  color: rgba(255, 255, 255, 0.3); }\n  .mat-select:focus:not(.mat-select-disabled) .bp-dark-theme .mat-select-trigger {\n    color: #616161; }\n  .mat-select.ng-invalid.ng-touched:not(.mat-select-disabled) .bp-dark-theme .mat-select-trigger {\n    color: #ff5722; }\n\n.bp-dark-theme .mat-select-underline {\n  background-color: rgba(255, 255, 255, 0.12); }\n  .mat-select:focus:not(.mat-select-disabled) .bp-dark-theme .mat-select-underline {\n    background-color: #616161; }\n  .mat-select.ng-invalid.ng-touched:not(.mat-select-disabled) .bp-dark-theme .mat-select-underline {\n    background-color: #ff5722; }\n\n.bp-dark-theme .mat-select-arrow {\n  color: rgba(255, 255, 255, 0.3); }\n  .mat-select:focus:not(.mat-select-disabled) .bp-dark-theme .mat-select-arrow {\n    color: #616161; }\n  .mat-select.ng-invalid.ng-touched:not(.mat-select-disabled) .bp-dark-theme .mat-select-arrow {\n    color: #ff5722; }\n\n.bp-dark-theme .mat-select-content, .bp-dark-theme .mat-select-panel-done-animating {\n  background: #424242; }\n\n.bp-dark-theme .mat-select-value {\n  color: white; }\n  .mat-select-disabled .bp-dark-theme .mat-select-value {\n    color: rgba(255, 255, 255, 0.3); }\n\n.bp-dark-theme .mat-sidenav-container {\n  background-color: #303030;\n  color: white; }\n\n.bp-dark-theme .mat-sidenav {\n  background-color: #424242;\n  color: white; }\n  .bp-dark-theme .mat-sidenav.mat-sidenav-push {\n    background-color: #424242; }\n\n.bp-dark-theme .mat-sidenav-backdrop.mat-sidenav-shown {\n  background-color: rgba(189, 189, 189, 0.6); }\n\n.bp-dark-theme .mat-slide-toggle.mat-checked:not(.mat-disabled) .mat-slide-toggle-thumb {\n  background-color: #ffe082; }\n\n.bp-dark-theme .mat-slide-toggle.mat-checked:not(.mat-disabled) .mat-slide-toggle-bar {\n  background-color: rgba(255, 224, 130, 0.5); }\n\n.bp-dark-theme .mat-slide-toggle.mat-slide-toggle-focused:not(.mat-checked) .mat-ink-ripple {\n  background-color: rgba(255, 255, 255, 0.12); }\n\n.bp-dark-theme .mat-slide-toggle.mat-slide-toggle-focused .mat-ink-ripple {\n  background-color: rgba(255, 224, 130, 0.26); }\n\n.bp-dark-theme .mat-slide-toggle.mat-primary.mat-checked:not(.mat-disabled) .mat-slide-toggle-thumb {\n  background-color: #eeeeee; }\n\n.bp-dark-theme .mat-slide-toggle.mat-primary.mat-checked:not(.mat-disabled) .mat-slide-toggle-bar {\n  background-color: rgba(238, 238, 238, 0.5); }\n\n.bp-dark-theme .mat-slide-toggle.mat-primary.mat-slide-toggle-focused:not(.mat-checked) .mat-ink-ripple {\n  background-color: rgba(255, 255, 255, 0.12); }\n\n.bp-dark-theme .mat-slide-toggle.mat-primary.mat-slide-toggle-focused .mat-ink-ripple {\n  background-color: rgba(238, 238, 238, 0.26); }\n\n.bp-dark-theme .mat-slide-toggle.mat-warn.mat-checked:not(.mat-disabled) .mat-slide-toggle-thumb {\n  background-color: #ffab91; }\n\n.bp-dark-theme .mat-slide-toggle.mat-warn.mat-checked:not(.mat-disabled) .mat-slide-toggle-bar {\n  background-color: rgba(255, 171, 145, 0.5); }\n\n.bp-dark-theme .mat-slide-toggle.mat-warn.mat-slide-toggle-focused:not(.mat-checked) .mat-ink-ripple {\n  background-color: rgba(255, 255, 255, 0.12); }\n\n.bp-dark-theme .mat-slide-toggle.mat-warn.mat-slide-toggle-focused .mat-ink-ripple {\n  background-color: rgba(255, 171, 145, 0.26); }\n\n.bp-dark-theme .mat-disabled .mat-slide-toggle-thumb {\n  background-color: #424242; }\n\n.bp-dark-theme .mat-disabled .mat-slide-toggle-bar {\n  background-color: rgba(255, 255, 255, 0.12); }\n\n.bp-dark-theme .mat-slide-toggle-thumb {\n  background-color: #bdbdbd; }\n\n.bp-dark-theme .mat-slide-toggle-bar {\n  background-color: rgba(255, 255, 255, 0.3); }\n\n.bp-dark-theme .mat-slider-track-background {\n  background-color: rgba(0, 0, 0, 0.26); }\n\n.bp-dark-theme .mat-slider-track-fill {\n  background-color: #ffc400; }\n\n.bp-dark-theme .mat-slider-thumb {\n  background-color: #ffc400; }\n\n.bp-dark-theme .mat-slider-thumb-label {\n  background-color: #ffc400; }\n\n.bp-dark-theme .mat-slider-thumb-label-text {\n  color: rgba(0, 0, 0, 0.87); }\n\n.bp-dark-theme .mat-slider:hover .mat-slider-track-background,\n.bp-dark-theme .mat-slider-active .mat-slider-track-background {\n  background-color: rgba(0, 0, 0, 0.38); }\n\n.bp-dark-theme .mat-slider-disabled .mat-slider-track-background,\n.bp-dark-theme .mat-slider-disabled .mat-slider-track-fill,\n.bp-dark-theme .mat-slider-disabled .mat-slider-thumb {\n  background-color: rgba(0, 0, 0, 0.26); }\n\n.bp-dark-theme .mat-slider-disabled:hover .mat-slider-track-background {\n  background-color: rgba(0, 0, 0, 0.26); }\n\n.bp-dark-theme .mat-slider-min-value.mat-slider-thumb-label-showing .mat-slider-thumb,\n.bp-dark-theme .mat-slider-min-value.mat-slider-thumb-label-showing .mat-slider-thumb-label {\n  background-color: black; }\n\n.bp-dark-theme .mat-slider-min-value.mat-slider-thumb-label-showing.mat-slider-active .mat-slider-thumb,\n.bp-dark-theme .mat-slider-min-value.mat-slider-thumb-label-showing.mat-slider-active .mat-slider-thumb-label {\n  background-color: rgba(0, 0, 0, 0.26); }\n\n.bp-dark-theme .mat-slider-min-value:not(.mat-slider-thumb-label-showing) .mat-slider-thumb {\n  border-color: rgba(0, 0, 0, 0.26);\n  background-color: transparent; }\n\n.bp-dark-theme .mat-slider-min-value:not(.mat-slider-thumb-label-showing):hover .mat-slider-thumb, .bp-dark-theme .mat-slider-min-value:not(.mat-slider-thumb-label-showing).mat-slider-active .mat-slider-thumb {\n  border-color: rgba(0, 0, 0, 0.38); }\n\n.bp-dark-theme .mat-slider-min-value:not(.mat-slider-thumb-label-showing):hover.mat-slider-disabled .mat-slider-thumb, .bp-dark-theme .mat-slider-min-value:not(.mat-slider-thumb-label-showing).mat-slider-active.mat-slider-disabled .mat-slider-thumb {\n  border-color: rgba(0, 0, 0, 0.26); }\n\n.bp-dark-theme .mat-tab-nav-bar,\n.bp-dark-theme .mat-tab-header {\n  border-bottom: 1px solid black; }\n  .mat-tab-group-inverted-header .bp-dark-theme .mat-tab-nav-bar, .mat-tab-group-inverted-header\n  .bp-dark-theme .mat-tab-header {\n    border-top: 1px solid black;\n    border-bottom: none; }\n\n.bp-dark-theme .mat-tab-label:focus {\n  background-color: rgba(245, 245, 245, 0.3); }\n\n.bp-dark-theme .mat-ink-bar {\n  background-color: #9e9e9e; }\n\n.bp-dark-theme .mat-toolbar {\n  background: #212121;\n  color: white; }\n  .bp-dark-theme .mat-toolbar.mat-primary {\n    background: #616161;\n    color: rgba(255, 255, 255, 0.87); }\n  .bp-dark-theme .mat-toolbar.mat-accent {\n    background: #ffc400;\n    color: rgba(0, 0, 0, 0.87); }\n  .bp-dark-theme .mat-toolbar.mat-warn {\n    background: #ff5722;\n    color: white; }\n\n.bp-dark-theme .mat-tooltip {\n  background: rgba(97, 97, 97, 0.9); }\n", ""]);
...
// module
exports.push([module.i, "/* You can add global styles to this file, and also import other style files */\n\nhtml, body {\n  margin: 0;\n  padding: 0;\n  font-family: sans-serif;\n  -webkit-font-smoothing: antialiased;\n  -moz-osx-font-smoothing: grayscale;\n}\n\n.add-toolbar {\n  padding: 0 0.5rem 0 1em;\n}\n\n.add-toolbar .add-toolbar-icon {\n  padding: 0 14px;\n}\n\n.add-fill-remaining {\n  -webkit-box-flex: 1;\n      -ms-flex: 1 1 auto;\n          flex: 1 1 auto;\n}\n\na:link,\na:visited,\na:active {\n  color: #000;\n}\na:hover {\n  color: #333;\n}\n\nmd-list-item h3 a:link,\nmd-list-item h3 a:visited,\nmd-list-item h3 a:active {\n  text-decoration: none;\n}\n\nmd-list-item h3 a:hover {\n  text-decoration: underline;\n}\n\nmd-icon.pointer {\n  cursor: pointer;\n}\n", ""]);
